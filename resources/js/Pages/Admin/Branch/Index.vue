  ...
  <AppLayout title="Branches">
    ...
    <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                  <thead class="bg-gray-50">
                    <tr>
                      ...
                      <th
                        ...
                        class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"
                      >
                        <span class="cursor-pointer" @click="sort('branch_desc')">
                          ...
                          <div class="inline-block">Branch Description</div></span
                        >
                      </th>
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    <tr v-if="!branches.data.length">
                      <td class="p-4 text-center text-sm text-gray-800" colspan="3">
                        <!-- NO data -->
        ...
        <div class="mx-auto sm:px-6 lg:px-8">
          <jet-pagination class="m-5" :links="branches.links" />
        </div>
      </div>
    </div>
  </AppLayout>
