<template>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    <tr v-if="!courses.data.length">
                      <td class="p-4 text-center text-sm text-gray-800" colspan="4">
                        <!-- NO data -->
  ...
  <dialog-modal :show="isOpen" @close="openModal(false)">
    ...
    <template #content>
      ...
      <!-- Name -->
      <div class="mb-4">
        <jet-label for="course_name" value="Course Name " />
        <jet-input
          id="course_name"
          ref="course_name"
          type="text"
      ...
      <!-- Desription -->
      <div class="mb-4">
        <jet-label for="course_desc" value="Course Description" />
        <jet-input
          id="course_desc"
          type="text"
          class="mt-1 block w-full"
...
export default {
  ...
  methods: {
    ...
    save: function (course) {
      this.$inertia.visit("/admin/course", {
        method: "post",
        data: course,
        onBefore: () => {
    ...
    update: function (course) {
      this.$inertia.visit("/admin/course/" + course.id, {
        method: "put",
        data: course,
        onBefore: () => {
          this.disabledClick(true);
    ...
    deleteRow: function (id) {
      this.$inertia.visit("/admin/course/" + id, {
        method: "delete",
        preserveScroll: true,
        onBefore: () => {
          this.disabledClick(true);
    ...
    clearFilters: function () {
      this.$inertia.get(this.route("admin.course.index"), {});
    },
  },
  ...
  watch: {
    params: {
      handler: throttle(function () {
        ...
        this.$inertia.get(this.route("admin.course.index"), params, {
          replace: true,
          preserveState: true,
        });
      }, 150),
